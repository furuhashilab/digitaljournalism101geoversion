...
原文: https://bit.ly/3gJkdag © 古田大輔作成, Vol.2.0（2020/12/14） から Fork

とりあえず、原文テキストをそのままペースト。順次Markdown化しつつ、古橋研究室用にジオ系ノウハウを追記・修正していきます（汎用的なものは原文に提案予定）。

---

（このドキュメントのリンクはこちら https://bit.ly/3gJkdag)
...
データ
プロダクト
Design Lab Handbook(En)
The Membership Guide(non-google)

メディア運営資料
DX
イノベーション・リポート
サブスクリプション
Towards your North Star: Report on the outcomes of the European GNI Subscriptions Lab 2020
...
政府のポータルサイト。まずはここから。
e-Stat
政府統計のポータル。データならここ。マイページ登録とメール登録で最新統計が届く。
DATA.GO.JP データベースサイト一覧
政府のDBサイトのDB。
官報情報検索サービス
全ての官報情報DB（有料）。無料版はインターネット版官報
JUDGIT
行政事業レビューシートのDB。国の予算の動きがわかる。
国立国会図書館オンライン
あらゆる出版物。手記、日記、論文、メモ、家計簿なども
国立国会図書館インターネット資料収集保存事業
国や自治体の過去のHPを再現。Wayback Maichineより強い。
国会会議録検索システム
国会発言のDB。
政治資金収支報告書
総務省。総務大臣届出分の3年分のPDF。
...
国が持っている企業情報DB
EDINET
上場企業の有価証券報告書や株の大量保有報告書を入手可
適時開示情報閲覧サービスTDnet
上場企業が重要情報を速報。食中毒、原産地偽装、災害で損失、インサイダー、脱税、提訴された、不正会計、耐震偽装など
職場情報総合サイト（しょくばらぼ）
社員の男女比率や管理職における女性の割合、平均残業時間など
マネーデータベース『製薬会社と医師』～あなたの医者をみつけよう
製薬会社から医師にどれだけの金が渡されたかが分かるDB
各種法人
NPO法人ポータルサイト
内閣府。
国・都道府県公式公益法人information
財団、社団
判例DB
裁判例検索
裁判所。公開されている判例は少ない。網羅性が高いのは民間の第一法規など（有料）。
訴訟記録は裁判所にて。１５０円の収入印紙が必要。
法令データ提供サービス
航空情報
ＪＡサーチ
日本の民間航空機DB
...
航空機の運行情報
海洋情報
Jobs At Sea | Marine Recruitment And Employment | Career At Maritime
海洋関係の人物DB
Marine Traffic 
漁船の運行情報
...
UNSD
国連統計部
アメリカ（日本側で見つからないものを探せる）
Public records online search
米国の公的記録ポータル
National Archives Catalog
米国立公文書館 。外交公電など全文検索、閲覧可能。
Public Access to Court Electronic Records
米連邦裁判所の訴訟記録をDLできる（有料）
その他
Wayback Machine
世界中の過去のHPを再現
ウェブ魚拓
